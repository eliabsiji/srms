...
$(function () {
    ...
    // ON SELECTING ROW
    $(".sel-arm").click(function () {
      //FINDING ELEMENTS OF ROWS AND STORING THEM IN VARIABLES
        var id = $(this).parents("tr").find("#tid").val();
        var a = $.trim($(this).parents("tr").find(".arm").text());
        var b = $.trim($(this).parents("tr").find(".remark").text());
        ...
        +'<span class="required">Term name</span>'
        +'</label>'
          +'<input class="form-control form-control-solid" placeholder="Arm name" name="arm" id="arm" value="'+a+'" />'
          +' </div>'
          ...
          +'<input type="text" name="remark" id="remark" value="'+b+'" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="House Name ..." required  />'
