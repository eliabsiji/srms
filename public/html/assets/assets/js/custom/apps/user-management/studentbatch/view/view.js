    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    html: "Are you sure you want to delete " + userName + " Batch Record from the database? <br> Deleting " + userName + "  Batch Record might affect other operations!!!",
                    icon: "warning",
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: "You have romoved " + userName + " from the database!.",
                            icon: "success",
                            buttonsStyling: false,
