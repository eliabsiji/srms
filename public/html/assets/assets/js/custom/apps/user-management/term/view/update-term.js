...
$(function () {
    ...
    // ON SELECTING ROW
    $(".sel-term").click(function () {
      //FINDING ELEMENTS OF ROWS AND STORING THEM IN VARIABLES
        var id = $(this).parents("tr").find("#tid").val();
        var a = $.trim($(this).parents("tr").find(".term").text());
        ...
        +'</label>'
          +'<input class="form-control form-control-solid" placeholder="Term name" name="term" id="term" value="'+a+'" />'
          +' </div>'
