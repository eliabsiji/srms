                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="{{ route('schoolarm.index') }}" class="text-muted text-hover-primary">School Session </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
    ...
    <div class="card">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_add_user_form" class="form" action="{{ route('schoolarm.store') }}" method="POST">
                                                            @csrf
                                                            <!--begin::Scroll-->
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-750px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div id="formcontent" class="modal-body scroll-y mx-5 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_update_role_form" class="form" action="{{ route('schoolarm.updatearm') }}" method="POST">
                                                            @csrf
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
           ...
           @foreach ($all_arms as $arm)
                    ...
                    <tr data-url="{{ route('schoolarm.destroy',$arm->id) }}">
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="1" />
                            </div>
                        </td>
                        <td class="armid">  <input type="hidden" id="tid"  value="{{ $arm->id }}" />{{ ++$i }}</td>
                            ...
                            <!--begin::Menu-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3" >
                                        ...
                                        data-url="{{ route('schoolarm.deletearm', ['armid'=>$arm->id]) }}"
