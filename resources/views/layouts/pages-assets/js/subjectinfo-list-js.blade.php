...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/subjectoinfo/list/add.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/account/settings/profile-details.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/subjectoinfo/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/subjectoinfo/view/update-subjectoinfo.js')}}"></script>
