                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="{{ route('myclass.index') }}" class="text-muted text-hover-primary">My Classes </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                                        ...
                                        <td >
                                            ...
                                            <!--begin::Menu-->
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    @can('view_student-list')
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">

                                                            <a href="viewstudent/{{ $sc->schoolclassID }}/{{ $sc->termid }}/{{ $sc->sessionid }}" class=" btn btn-light btn-active-primary"  title="View Students in {{$sc->schoolclass}}  {{ $sc->schoolarm}} Class" >View Students</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endcan
                                                </div>
