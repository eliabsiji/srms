            ...
            <div class="col-md-4">
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title" >  <h2> {{ $sn++ }}-- &nbsp;&nbsp;</h2>
                            <h2 style="color: green">{{ $subject->subject}}</h2>&nbsp;
                            <h2 style="color: green">{{ $subject->subjectcode }}</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    ...
                    <div class="card-body pt-1">
                        <!--begin::Users-->
                            ...
                            <div class="fw-bold text-gray-600 mb-5" ><h3 style="color: red"> {{ $subject->schoolclass }}: {{ $subject->arm}}</h3></div>
                            <!--end::Users-->
                            <div class="d-flex flex-column text-gray-600">
                            <!--begin::Permissions-->


                                <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> <h4 style="color: brown">{{ $subject->term }}:{{ $subject->session }}</h4></div>
                    ...
                    <!--end::Card body-->
                        ...
                        <div class="card-footer flex-wrap pt-3">
                            ...
                            <a href="" class="btn btn-light btn-sm  btn-active-primary my-1 me-2">View </a>
