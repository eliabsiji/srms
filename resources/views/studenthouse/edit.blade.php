                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Student BioData Info</h3>
                                    <div class="card-options ">
                                        <a class="btn btn-primary" href="{{ route('student.index') }}"> Back to Student</a>
                                ...
                                <div class="card">
                                    ...
                                    {!! Form::model($student, ['route' => ['student.update', $value->sid], 'method'=>'PATCH','class'=>'form-horizontal form-stripe','onSubmit'=>'age();']) !!}
                                            @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"  name="admissionNo" id="name"  placeholder="Name"  value="{{ $value->admissionNo }}" readonly required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                    ...
                                                    <select  class="form-control" name="tittle" id="tittle" required>
                                                        @if ($value->title == "")
                                                        <option value="">Select Title</option>
                                                        @else
                                                            <option value="{{ $value->title }}" selected>Select  Title </option>
                                                        @endif

                                                        <option value="Mr">Mr</option>
                                                        <option value="Mrs">Mrs</option>
                                                        <option value="Miss">Miss</option>
                                                    </select>[ Previously Selected: <span style="color: blue ">  {{ $value->title }} </span> ]
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="firstname" id="name"  placeholder="First Name" value="{{ $value->firstname }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="lastname" id="name"  placeholder="LAst Name" value="{{ $value->lastname }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="othername" id="name"  placeholder="Other Name" value="{{ $value->othername }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <select  class="form-control" name="gender" id="gender" required>
                                                        ...
                                                        @else
                                                            <option value="{{ $value->gender }}" selected>Select  Gender </option>
                                                        @endif

                                                       <option value="Male">Male</option>
                                                        <option value="Female">Female</option>
                                                    </select>[ Previously Selected: <span style="color: blue "> {{ $value->gender }}  </span>]
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="home_address" id="employmentid"  placeholder="Home Address"  value="{{ $value->homeadd }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="home_address2" id="employmentid"  placeholder="Home Address2"  value="{{ $value->homeadd2 }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="date" class="form-control"  name="dateofbirth" id="dateofbirth"  placeholder="Date of Birth" onkeyup="showage()" value="{{ $value->dob }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="age1" id="age1"  placeholder="Age" onkeyup="showage()" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="placeofbirth" id="placeofbirth"  placeholder="Plate of Birth" value="{{ $value->pob }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" name="nationality" id="nationality"  placeholder="nationality" value="{{ $value->nation }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select  class="form-control" id="state" data-rel="chosen" name="state" >
                                                        ...
                                                        @if ($value->state  == "" || $value->state == -1)
                                                        <option value="{{ $value->state }}">Select Local Goverment</option>
                                                        @else
                                                            <option value="{{ $value->state }}" selected>Select  State</option>
                                                        @endif



                                                    </select>[ Previously Selected: <span style="color: blue ">  {{ $value->state }} </span> ]
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select  class="form-control" id="local" data-rel="chosen" name="local" >
                                                        ...
                                                        @else
                                                            <option value="{{ $value->local }}" selected>Select  Local Goverment</option>
                                                        @endif


                                                    </select>[ Previously Selected: <span style="color: blue ">  {{ $value->local }} </span> ]
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select  class="form-control" id="religion" data-rel="chosen" name="religion" >
                                                        ...
                                                        @else
                                                            <option value="{{ $value->religion }}" selected>Select  Religion</option>
                                                        @endif

                                                       <option value="Christianity">Christianity</option>
                                                        <option value="Islam">Islam</option>
                                                        <option value="others">Others</option>
                                                     </select>[ Previously Selected: <span style="color: blue "> {{ $value->religion }}  </span> ]
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" name="last_school" id="nationality"  placeholder="Last School" value="{{ $value->lastsch }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" name="last_class" id="nationality"  placeholder="Last Class " value="{{ $value->lastclass }}" >
                                                </div>
                                            </div>
                                       ...
                                       <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select name ="schoolclassid" id="schoolclassid"  class="form-control" >
                                                        ...
                                                        @else
                                                            <option value="{{ $value->sclassid }}" selected>Select  Class</option>
                                                        @endif
                                                           @foreach ($schoolclass as $class => $name )
                                                         <option value="{{$name->id}}">{{ $name->schoolclass }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ $name->arm}} </option>
                                                        @endforeach
                                                    </select> [ Previously Selected: <span style="color: blue ">   {{  $value->schoolclass }}  {{ $value->arm }} </span>]
                                                </div>
                                            </div>
