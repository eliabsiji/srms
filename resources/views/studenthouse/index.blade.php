            ...
            <div class="d-flex justify-content-between align-items-center ">
                <div class="header-action">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Student House</li>
                    </ol>
                </div>
                <ul class="nav nav-tabs page-header-tab">
                    ...
                    <li class="nav-item"><a class="nav-link" id="Library-tab-Boot" data-toggle="tab" href="#student-add">School House Update</a></li>
                    @endcan
        ...
        <div class="container-fluid">
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="student">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('studenthouse.store') }}" method="POST">

                                @csrf
                                    <input type="hidden" name="id" value=" {{ $student->studentid }}">
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Choose School House</label>
                                    <div class="col-md-9">
                                        <select name ="schoolhouseid" id="schoolhouseid"  class="form-control" required>
                                            <option value="" selected>Select House</option>
                                               @foreach ($schoolhouse as $st => $name )
                                             <option value="{{$name->id}}">{{ $name->house }}  .........{{ $name->housecolour }}  </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <button type="submit" class="btn btn-primary">Upload Student House</button>
