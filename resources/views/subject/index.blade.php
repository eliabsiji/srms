                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="{{ route('subject.index') }}" class="text-muted text-hover-primary">Subject </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-750px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div id="formcontent" class="modal-body scroll-y mx-5 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_update_role_form" class="form" action="{{ route('subject.updatesubject') }}" method="POST">
                                                            @csrf
            ...
            <tbody class="fw-semibold text-gray-600">
               ...
               @foreach ($allSubjects as $subject)
                    ...
                    <tr data-url="{{ route('subject.destroy',$subject->id) }}">
                        ...
                        <td class="subjectid">  <input type="hidden" id="tid"  value="{{ $subject->id }}" />{{ ++$i }}</td>
                        <td id="subject" class=" subject"> {{ $subject->subject }} </td>
                        <td id="subject" class=" subjectcode"> {{ $subject->subject_code }} </td>
                        <td id="subject" class=" remark"> {{ $subject->remark }} </td>
                            ...
                            <!--begin::Menu-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3" >
                                        ...
                                        data-url="{{ route('subject.deletesubject', ['subjectid'=>$subject->id]) }}"
