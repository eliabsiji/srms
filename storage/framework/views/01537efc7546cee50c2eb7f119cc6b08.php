                ...
                ?>
                    ...
                    <tr>
                        ...
                        <div class="d-flex flex-column">
                            <a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo e($permission->title); ?></a>
                            <span><?php echo e($permission->name); ?></span>
                        </div>
                        <!--begin::User details-->
                        </td>
                        <td>
                             <?php $__currentLoopData = $rolePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <a href="<?php echo e(route('roles.index',)); ?>" class="<?php echo e($r->badge); ?> fs-7 m-1"><?php echo e($r->name); ?></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/permissions/index.blade.php ENDPATH**/ ?>