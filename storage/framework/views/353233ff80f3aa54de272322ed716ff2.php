...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myresultroom/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/account/settings/profile-details.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myresultroom/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myresultroom/view/update-myresultroom.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\srms\resources\views/layouts/pages-assets/js/myresultroom-list-js.blade.php ENDPATH**/ ?>