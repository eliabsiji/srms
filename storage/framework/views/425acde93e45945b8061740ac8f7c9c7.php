                ...
                <div class="tab-pane active" id="edit-arm">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="<?php echo e(route('parent.index')); ?>"> Back to Parent</a>
                            ...
                            <div class="tab-pane active" id="biodata">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form  role="form" id="inline-validation" class="form-horizontal form-stripe" action="<?php echo e(route('parent.store')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>

                                            <input type="hidden" name="sid" value="<?php echo e($student->id); ?>">
                                      ...
                                      <script type="text/javascript">
                                        ...
                                        <h6 class="mb-xlg text-center"><b>( <?php echo e($student->admissionNo); ?>) <?php echo e($student->firstname); ?> <?php echo e($student->lastname); ?>'s Parent Bio Data Info</b></h6>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                    ...
                                                    <select  class="form-control" name="father_title" id="father_title" >
                                                        <?php if($parent->father_title == ""): ?>
                                                            <option value="">Select Title </option>
                                                        <?php else: ?>
                                                        <option value="<?php echo e($parent->father_title); ?>" selected>Select  </option>
                                                        <?php endif; ?>
                                                    ...
                                                    </select>[ Previously Selected: <span style="color: blue ">  <?php echo e($parent->father_title); ?> </span>]
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="father" id="Father" value="<?php echo e($parent->father); ?>" placeholder="Name" >
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                        ...
                                                        <select  class="form-control" name="mother_title" id="mother_title" >
                                                            <?php if($parent->mother_title == ""): ?>
                                                                <option value="">Select Title </option>
                                                            <?php else: ?>
                                                            <option value="<?php echo e($parent->mother_title); ?>" selected>Select Title  </option>
                                                            <?php endif; ?>
                                                        ...
                                                        </select>[ Previously Selected:<span style="color: blue ">  <?php echo e($parent->mother_title); ?> </span>]
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="mother" id="name"  placeholder="Mother's Name" value="<?php echo e($parent->mother); ?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="father_phone" id="name" value="<?php echo e($parent->father_phone); ?>" placeholder="phone number" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="mother_phone" id="name" value="<?php echo e($parent->mother_phone); ?>"  placeholder="phone number" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="parent_address" id="name" value="<?php echo e($parent->parent_address); ?>"  placeholder="parent address" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="office_address" id="name" value="<?php echo e($parent->office_address); ?>" placeholder="office address" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"  name="father_occupation" id="name" value="<?php echo e($parent->father_occupation); ?>" placeholder="Ocuppation" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                        ...
                                                        <select  class="form-control" name="religion" id="religion" >
                                                            <?php if($parent->religion == ""): ?>
                                                                <option value="">Select Religion </option>
                                                            <?php else: ?>
                                                            <option value="<?php echo e($parent->religion); ?>" selected>Select Religion  </option>
                                                            <?php endif; ?>

                                                            <option value="Christianity">Christianity</option>
                                                            <option value="Islam">Islam</option>
                                                            <option value="others">Others</option>
                                                        </select>[Previously Selected: <span style="color: blue ">  <?php echo e($parent->religion); ?></span> ]
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/parent/edit.blade.php ENDPATH**/ ?>