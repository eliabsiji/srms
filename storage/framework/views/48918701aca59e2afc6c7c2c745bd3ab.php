...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/subjectoperation/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/account/settings/profile-details.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/subjectoperation/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/subjectoperation/view/update-subjectoperation.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\srms\resources\views/layouts/pages-assets/js/subjectoperation-list-js.blade.php ENDPATH**/ ?>