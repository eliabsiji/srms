                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('student.index')); ?>" class="text-muted text-hover-primary">Student Bulk Upload </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
...
<!--begin::Primary button-->
    <a href="<?php echo e(route('student.batchindex')); ?>" class="btn btn-sm fw-bold btn-primary" >
    << Back        </a>
<!--end::Primary button-->
</div>
<!--end::Actions-->
                        ...
                        <!--end::Label-->
                                ...
                                <div class="fv-row mb-7">
                                        ...
                                        <select name ="schoolclassid" id="schoolclassid"  class="form-control form-control-solid mb-3 mb-lg-0" required>
                                            ...
                                            <?php $__currentLoopData = $schoolclass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sc->id); ?>"> <?php echo e($sc->schoolclass); ?>.....<?php echo e($sc->arm); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <!--end::Input-->
                    ...
                    <div class="mb-7">
                        ...
                        <!--end::Label-->
                                ...
                                <select name ="termid" id="termid"  class="form-control form-control-solid mb-3 mb-lg-0" required>
                                    ...
                                    <?php $__currentLoopData = $schoolterm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sc->id); ?>"> <?php echo e($sc->term); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <!--end::Input-->
                                ...
                                <!--end::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                                ...
                                                <select name ="sessionid" id="sessionid"  class="form-control form-control-solid mb-3 mb-lg-0" required>
                                                    ...
                                                    <?php $__currentLoopData = $schoolsession; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($sc->id); ?>"> <?php echo e($sc->session); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <!--end::Input-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/student/bulkupload.blade.php ENDPATH**/ ?>