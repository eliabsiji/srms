                ...
                <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                            ...
                            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                              ...
                              <p style="color: green" >My Class</p>
                                        </h1>
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('myclass.index')); ?>" class="text-muted text-hover-primary">My Classes </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px" style="color: green">Class</th>
                                    <th class="min-w-125px" style="color: green">Arm</th>
                                    <th class="min-w-125px" style="color: green">Term</th>
                                    <th class="min-w-100px" style="color: green">Session</th>
                                        ...
                                        <td >
                                            ...
                                            <!--begin::Menu-->
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_student-list')): ?>
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">

                                                            <a href="viewstudent/<?php echo e($sc->schoolclassID); ?>/<?php echo e($sc->termid); ?>/<?php echo e($sc->sessionid); ?>" class=" btn btn-light btn-active-primary"  title="View Students in <?php echo e($sc->schoolclass); ?>  <?php echo e($sc->schoolarm); ?> Class" >View Students</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    <?php endif; ?>
                                                </div>
