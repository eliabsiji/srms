                                ...
                                <!--end::Title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                        ...
                                                        <li class="breadcrumb-item text-muted">
                                                            <a href="<?php echo e(route('schoolhouse.index')); ?>" class="text-muted text-hover-primary">School House </a>
                                                                        </li>
                                                            <!--end::Item-->
                                                                <!--begin::Item-->
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_add_user_form" class="form" action="<?php echo e(route('schoolhouse.store')); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <!--begin::Scroll-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                            ...
                                                                            <div class="fv-row mb-7">
                                                                                    ...
                                                                                    <select name ="housemasterid" id="housemasterid" class="form-control form-control-solid mb-3 mb-lg-0"  >
                                                                                        ...
                                                                                        <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <div class="fv-row mb-7">
                                                                                    ...
                                                                                    <select name ="termid" id="termid" class="form-control form-control-solid mb-3 mb-lg-0"  >
                                                                                        <option value="" selected>Select Term </option>
                                                                                            <?php $__currentLoopData = $schoolterm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    ...
                                                                                    <div class="fv-row mb-7">
                                                                                            ...
                                                                                            <select name ="sessionid" id="sessionid" class="sel-sesson form-control form-control-solid mb-3 mb-lg-0"  >
                                                                                                <option value="" selected>Select Session </option>
                                                                                                    <?php $__currentLoopData = $schoolsession; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schsess => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-750px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div id="formcontent" class="modal-body scroll-y mx-5 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_update_role_form" class="form" action="<?php echo e(route('schoolhouse.updatehouse')); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                <?php
                 $i = 0
               ?>
            <?php $__currentLoopData = $schoolhouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr data-url="<?php echo e(route('schoolhouse.destroy',$sc->id)); ?>">
                        ...
                        <td class="housemaster"><input type="hidden" id="housemaster"  value="<?php echo e($sc->name); ?>" /><?php echo e($sc->name); ?>
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="<?php echo e(route('users.show',$sc->id)); ?>">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="<?php echo e(route('users.show',$sc->id)); ?>" class="text-gray-800 text-hover-primary mb-1"><?php echo e($sc->housemaster); ?></a>
                                            <span><?php echo e($sc->housemaster); ?></span>
                                        </div>
                        ...
                        <td >
                            ...
                            <!--begin::Menu-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('schoolhouse-edit')): ?>
                                        <!--begin::Menu item-->
                                        ...
                                        <!--end::Menu item-->
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('schoolhouse-delete')): ?>
                                    <div class="menu-item px-3" >
                                        ...
                                        data-url="<?php echo e(route('schoolhouse.deletehouse', ['houseid'=>$sc->id])); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/schoolhouse/index.blade.php ENDPATH**/ ?>