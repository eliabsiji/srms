...
<div id="kt_account_settings_profile_details" class="collapse show">
    ...
    enctype="multipart/form-data" action="<?php echo e(route('student.store')); ?>" >
      <?php echo csrf_field(); ?>
        <!--begin::Card body-->
        <div class="card-body border-top p-9">
            <input type="hidden" name="registeredBy" value="<?php echo e(Auth::user()->id); ?>">
            <!--begin::Input group-->
            <div class="row mb-6">
                <!--begin::Label-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/student/create.blade.php ENDPATH**/ ?>