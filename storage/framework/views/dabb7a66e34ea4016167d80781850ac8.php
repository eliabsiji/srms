...
<?php $__env->startSection('content'); ?>
     ...
     <div class="alert alert-success alert-dismissible">
        <a class="btn btn-primary" href="<?php echo e(route('student.index')); ?>"> Back to Students</a>
         <button type="button" class="close" data-dismiss="alert"></button>
                                ...
                                <table class="table table-hover js-basic-example dataTable table-striped table_custom">
                                    ...
                                    <tbody>
                                     ...
                                     <tr id="sid<?php echo e($sc->id); ?>">
                                         ...
                                         <td><?php echo e($sc->firstname); ?> <?php echo e($sc->lastname); ?></td>
                                          <?php
                                         ...
                                         <td>
                                             <div class="btn-group">
                                                 ...
                                                 <a href="<?php echo e(route('student.edit',$sc->id)); ?>" class="btn fa fa-pencil" data-toggle="tooltip" title="Edit Student Data"></a>
                                                 <?php endif; ?>
                                                 </div>
                                             <div class="btn-group">
                                             ...
                                             <a href="javascript:void(0)" class="btn fa fa-trash delete"
                                                 data-toggle="tooltip" title="Delete Student Data" onClick="check(<?php echo e($sc->id); ?>)"></a>
                                               <?php endif; ?>
                                         </div>
                                     </td>
                                     <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('parent-edit')): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('parent.edit',$sc->id)); ?>">Parent Bio Data</a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('student-picture-upload')): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('studentImageUpload.edit',$sc->id)); ?>">Student Picture</a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-studenthouse')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('studenthouse.edit',$sc->id)); ?>">Student House</a>
                                            <?php endif; ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card">
                                 ...
                                 <form  role="form" id="inline-validation" class="form-horizontal form-stripe" action="<?php echo e(route('student.store')); ?>" onSubmit="age();" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\srms\resources\views/student/index.blade.php ENDPATH**/ ?>