        ...
        <div class="card-body py-5">
            ...
            <div class="mh-450px scroll-y me-n5 pe-5">
                ...
                <div class="row g-2">
                                            <!--begin::Col-->
                        <div class="col-4">
                            <a href="<?php echo e(route('journalcategory.index')); ?>" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
...
<!--end::Header-->
<?php /**PATH C:\xampp\htdocs\srms\resources\views/layouts/inc/header.blade.php ENDPATH**/ ?>